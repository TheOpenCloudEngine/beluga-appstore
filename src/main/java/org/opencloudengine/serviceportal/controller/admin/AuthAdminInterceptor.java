package org.opencloudengine.serviceportal.controller.admin;
...
public class AuthAdminInterceptor extends HandlerInterceptorAdapter {
	protected static Logger logger = LoggerFactory.getLogger(AuthAdminInterceptor.class);

    private static final String LOGIN_PAGE = "/a/login";
